var AlphaVideo = function(videoUrl, loop){
    video = document.getElementById('game_video');
    ...
    if (!gl){
        document.body.classList.add('no_webgl');
    ...
    function frameloop() {
        ...
        if (videoready) {
            try {
                // upload the video frame ios10 有bug
    ...
    // ios10.3 有bug
    if( navigator.userAgent.indexOf(' iPhone OS 10_3') > -1 ){
        document.body.classList.add('no_webgl');
    }else{
        frameloop();
    } 
