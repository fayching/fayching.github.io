/**
 * Created by lomoliang on 2017/1/11.
 */
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.dataKeyNum = params.dataKeyNum;
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                var style_displayCity = "";
                var style_displayCounty = "";
                if(_self.dataKeyNum == 1){
                    style_displayCity = style_displayCounty = " style='display:none;'"
                }else if(_self.dataKeyNum == 2){
                    style_displayCounty = " style='display:none;'"
                }
        ...
        setGearTooth: function(data) {
            ...
            if (l > 0) {
                ...
                switch (_self.type) {
                    case 1:
                        childData = item[gearVal].CITY_LIST
                        break;
                    case 2:
        ...
        finish: function(e) {
            ...
            _self.valueTo.value = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));

            _self.value = [provinceVal, cityVal, countyVal];
            console.log(_self.valueTo)
            if(_self.valueTo){
                console.log('cityCode',cityCode);
                _self.valueTo.value = cityCode
            }
            if(_self.params.areaID) {
                _self.params.areaID = cityCode;
            }
            _self.close(e);
        },
        close: function(e) {
